...
function getApiKey() {
  return fetch("http://192.168.1.105/js/openWeatherApiKey.json")
...
//document.querySelector(".shmo").addEventListener("click", getForecastPrintFullTable());
//document.querySelector(".shle").addEventListener("click", getForecastPrintSmallTable());
